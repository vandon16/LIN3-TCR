...
kc = LINETCR.LINE()
kc.login(token="ElNj7fMK3CxVOAnGFMK6.57SW4iTG0dZpmyfBso2c5G.mgTqSrAw7l4EbSZ5d4c7bzZlIx7qljtaFvMah1RQT8M=")
...
helpMessage =""" [PeKI] BOT 1st Gen  􀔃􀄆red check mark􏿿

􀔃􀅕red arrow right􏿿 Command Public
Ini adalah Generasi 1 BOT PeKI
Silahkan dinikmati
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u08c2dd7a54d7d8718a6827d22afcfbc0","uc17663698bf499304c0b424c2dbaf754","u87b730feea85597fad9ab7c6eb362714","u7f2fd0b9ccd162506d83210dd8c9de71","u316be5f6be369be553cd3f5dc575fda1"]
admin=["u08c2dd7a54d7d8718a6827d22afcfbc0","uc17663698bf499304c0b424c2dbaf754","u87b730feea85597fad9ab7c6eb362714","u7f2fd0b9ccd162506d83210dd8c9de71","u316be5f6be369be553cd3f5dc575fda1"]
wait = {
    'contact':True,
    'autoJoin':True,
              ...
              if msg.from_ in admin:
                ...
                if msg.toType == 2:
                    ...
                    if G.invitee is not None:
                        ...
                        km.cancelGroupInvitation(msg.to, gInviMids)
                    else:
                        if wait["lang"] == "JP":
                            km.sendText(msg.to,"No one is inviting")
                        else:
                            km.sendText(msg.to,"Sorry, nobody absent")
                else:
                    if wait["lang"] == "JP":
                        km.sendText(msg.to,"Can not be used outside the group")
                    else:
                        km.sendText(msg.to,"Not for use less than group")
            #elif "gurl" == msg.text:
...
km.sendText(msg.to,Fmid)    
                ...
                kc.sendText(msg.to,Cmid)
            elif msg.text in ["Welcome kak"]:
                msg.contentType = 7
                msg.text = "Selamat datang di event BRC"
                #msg.contentMetadata = {
                                     #"STKID": "100",
                                     #"STKPKGID": "1",
                                     #"STKVER": "100" }
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["All Join","All join","hadir hadir hadir","hadirrr","hadir sedulurku"]:
              if msg.from_ in admin :
...
km.acceptGroupInvitationByTicket(msg.to,Ticket)
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Pamit sek lurr","PeKI Pamit","Bubarrr"]:
              if msg.from_ in admin:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
...
km.leaveGroup(msg.to)                        
    ...
    #-------------Fungsi Tagall User Finish-------------#
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        ...
                        kc.sendText(msg.to,"Semoga tenang disana􀨁􀆷devil smile􏿿")
                        return
                    for jj in matched_list:
                        try:
                            klist=[ki,kk,kc,km,kn]
                ...
                if msg.toType == 2:
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        cl.sendText(msg.to,"Dulur dewe mbah")
                        ki.sendText(msg.to,"Dulur dewe mbah")
                        kk.sendText(msg.to,"Dulur dewe mbah")
                        kc.sendText(msg.to,"Dulur dewe mbah")
                    else:
                        for target in targets:
                            try:
                                wait["blacklist"][target] = True
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                cl.sendText(msg.to,"Sampun dititeni")
                            except:
                                ki.sendText(msg.to,"Error")
        ...
        #-------------Fungsi Spam Start---------------------#
            elif msg.text in ["pokoke rusuh lurrr"]:
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
            elif msg.text in ["Cek on","dulur","cek on","hadir"]:
                cl.sendText(msg.to,"Nggeh lurr")
                ki.sendText(msg.to,"Pripun lurr")
                kk.sendText(msg.to,"Ngopi sek lurr")
                kc.sendText(msg.to,"Yowes dipenakne..")
      ...
      #-------------Fungsi Balesan Respon Finish---------------------#
       ...
       #-------------Fungsi Speedbot Start---------------------#
            elif msg.text in ["Sp","Speedbot","speedbot","jajal heningke"]:
                start = time.time()
                cl.sendText(msg.to, "Nggeh sekedap")
      ...
      #-------------Fungsi Bannlist Finish------------------#  
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"Blacklist pulang dulu")
                    ki.sendText(msg.to,"Ojo mampir ngopi")
                    kk.sendText(msg.to,"Sampean kurang turu")
                    kc.sendText(msg.to,"Sholatmu kurang sak rakaat")
